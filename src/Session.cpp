...
const Session::ClientList& Session::clients () const
{
	return m_clients;
}
...
// Critical methods.
bool Session::save ( const QString& sSessionDir, int iSessionType )
{
...
bool Session::load ( const QString& sSessionDir )
{
...
bool Session::loadFile ( const QString& sFilename )
{
	// Open file...
...
bool Session::saveFile ( const QString& sFilename )
{
...
Session::InfraClientList& Session::infra_clients ()
{
...
void Session::loadInfraClients ( QSettings& settings )
{
	clearInfraClients();
...
void Session::saveInfraClients ( QSettings& settings )
{
	settings.beginGroup("/InfraClients");
...
void Session::clearInfraClients ()
{
...
bool Session::isJackClient ( const QString& sClientName ) const
{
