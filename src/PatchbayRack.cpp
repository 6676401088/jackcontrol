...
public:
	...
	void commit ( PatchbayRack *pRack, int iSocketType )
	{
		...
		for ( ; iter != m_hash.end(); ++iter) {
			...
			const QString& sIClient = sKey.section(':', 1);
...
// Default destructor.
qjackctlPatchbaySocket::~qjackctlPatchbaySocket ()
{
	m_pluglist.clear();
}
...
const QString& qjackctlPatchbaySocket::name () const
{
	return m_sSocketName;
}

const QString& qjackctlPatchbaySocket::clientName () const
{
	return m_sClientName;
}

int qjackctlPatchbaySocket::type () const
{
	return m_iSocketType;
}

bool qjackctlPatchbaySocket::isExclusive () const
{
	return m_bExclusive;
}

const QString& qjackctlPatchbaySocket::forward () const
{
...
// Plug list accessor.
QStringList& qjackctlPatchbaySocket::pluglist ()
{
	return m_pluglist;
}
...
const QString& qjackctlPatchbaySlot::name () const
{
	return m_sSlotName;
}

int qjackctlPatchbaySlot::mode () const
{
	return m_iSlotMode;
}
...
// Socket accessors.
qjackctlPatchbaySocket *qjackctlPatchbaySlot::outputSocket () const
{
	return m_pOutputSocket;
}

qjackctlPatchbaySocket *qjackctlPatchbaySlot::inputSocket () const
{
...
// Socket accessors.
qjackctlPatchbaySocket *qjackctlPatchbayCable::outputSocket () const
{
	return m_pOutputSocket;
}

qjackctlPatchbaySocket *qjackctlPatchbayCable::inputSocket () const
{
	return m_pInputSocket;
}
...
void PatchbayRack::removeSocket (
	QList<qjackctlPatchbaySocket *>& socketlist,
	qjackctlPatchbaySocket *pSocket )
{
...
void PatchbayRack::addSlot ( qjackctlPatchbaySlot *pSlot )
{
...
void PatchbayRack::removeSlot ( qjackctlPatchbaySlot *pSlot )
{
...
void PatchbayRack::addCable ( qjackctlPatchbayCable *pCable )
{
...
void PatchbayRack::removeCable ( qjackctlPatchbayCable *pCable )
{
...
qjackctlPatchbaySocket *PatchbayRack::findSocket (
	QList<qjackctlPatchbaySocket *>& socketlist,
...
qjackctlPatchbaySlot *PatchbayRack::findSlot ( const QString& sSlotName )
{
...
// Cable finders.
qjackctlPatchbayCable *PatchbayRack::findCable (
...
QList<qjackctlPatchbaySocket *>& PatchbayRack::osocketlist ()
{
...
QList<qjackctlPatchbaySocket *>& PatchbayRack::isocketlist ()
{
...
QList<qjackctlPatchbaySlot *>& PatchbayRack::slotlist ()
{
	return m_slotlist;
}
...
QList<qjackctlPatchbayCable *>& PatchbayRack::cablelist ()
{
	return m_cablelist;
}
...
const char *PatchbayRack::findJackPort ( const char **ppszJackPorts,
...
void PatchbayRack::connectJackPorts (
...
void PatchbayRack::disconnectJackPorts (
	const char *pszOutputPort, const char *pszInputPort )
{
	unsigned int uiCableFlags = QJACKCTL_CABLE_FAILED;
...
void PatchbayRack::checkJackPorts (
	const char *pszOutputPort, const char *pszInputPort )
{
	emit cableConnected(
...
void PatchbayRack::connectJackSocketPorts (
...
void PatchbayRack::connectJackCable (
...
void PatchbayRack::connectJackScan ( jack_client_t *pJackClient )
{
...
void PatchbayRack::loadAlsaPorts (
...
void PatchbayRack::loadAlsaConnections (
...
qjackctlAlsaMidiPort *PatchbayRack::findAlsaPort (
	QList<qjackctlAlsaMidiPort *>& midiports,
	const QString& sClientName, const QString& sPortName, int n )
{
	QRegExp rxClientName(sClientName);
...
QString PatchbayRack::getAlsaPortName ( qjackctlAlsaMidiPort *pMidiPort )
{
...
// MIDI port-pair name string.
void PatchbayRack::setAlsaPort ( qjackctlAlsaMidiPort *pMidiPort,
...
void PatchbayRack::connectAlsaPorts (
...
void PatchbayRack::disconnectAlsaPorts (
	qjackctlAlsaMidiPort *pOutputPort, qjackctlAlsaMidiPort *pInputPort )
{
#ifdef CONFIG_ALSA_SEQ
...
void PatchbayRack::checkAlsaPorts (
	qjackctlAlsaMidiPort *pOutputPort, qjackctlAlsaMidiPort *pInputPort )
{
	emit cableConnected(
		getAlsaPortName(pOutputPort),
...
void PatchbayRack::connectAlsaSocketPorts (
...
void PatchbayRack::connectAlsaCable (
	qjackctlPatchbaySocket *pOutputSocket, qjackctlPatchbaySocket *pInputSocket )
{
	if (pOutputSocket == NULL || pInputSocket == NULL)
		return;
...
void PatchbayRack::connectAlsaScan ( snd_seq_t *pAlsaSeq )
{
...
void PatchbayRack::connectJackForwardPorts (
...
void PatchbayRack::connectJackForward (
...
void PatchbayRack::connectAlsaForwardPorts (
...
void PatchbayRack::connectAlsaForward (
	qjackctlPatchbaySocket *pSocket, qjackctlPatchbaySocket *pSocketForward )
{
	if (pSocket == NULL || pSocketForward == NULL)
		return;
...
void PatchbayRack::connectForwardScan ( int iSocketType )
{
...
void PatchbayRack::connectJackSnapshotEx ( int iSocketType )
{
	...
	for (int i = 0; ppszOutputPorts[i]; ++i) {
		...
		const QString& sOPort   = sOutputPort.section(':', 1);
		qjackctlPatchbaySnapshot::add_socket(
...
void PatchbayRack::connectJackSnapshot ( jack_client_t *pJackClient )
{
	if (pJackClient == NULL || m_pJackClient)
		return;
...
void PatchbayRack::connectAlsaSnapshot ( snd_seq_t *pAlsaSeq )
{
	if (pAlsaSeq == NULL || m_pAlsaSeq)
		return;
