...
// Constructor.
MessagesStatusWidget::MessagesStatusWidget (
...
void MessagesStatusWidget::showEvent ( QShowEvent *pShowEvent )
{
...
void MessagesStatusWidget::hideEvent ( QHideEvent *pHideEvent )
{
...
void MessagesStatusWidget::closeEvent ( QCloseEvent * /*pCloseEvent*/ )
{
	QWidget::hide();
...
// Tab page accessors.
void MessagesStatusWidget::setTabPage ( int iTabPage )
{
	m_ui.MessagesStatusTabWidget->setCurrentIndex(iTabPage);
}

int MessagesStatusWidget::tabPage () const
{
...
QFont MessagesStatusWidget::messagesFont () const
{
	return m_ui.MessagesTextView->font();
}

void MessagesStatusWidget::setMessagesFont ( const QFont & font )
{
...
int MessagesStatusWidget::messagesLimit () const
{
	return m_iMessagesLimit;
}

void MessagesStatusWidget::setMessagesLimit ( int iMessagesLimit )
{
...
bool MessagesStatusWidget::isLogging () const
{
	return (m_pMessagesLog != NULL);
}

void MessagesStatusWidget::setLogging ( bool bEnabled, const QString& sFilename )
{
	if (m_pMessagesLog) {
...
void MessagesStatusWidget::appendMessagesLog ( const QString& s )
{
	if (m_pMessagesLog) {
...
void MessagesStatusWidget::appendMessagesLine ( const QString& s )
{
...
void MessagesStatusWidget::appendMessages ( const QString& s )
{
	appendMessagesColor(s, "#999999");
}

void MessagesStatusWidget::appendMessagesColor ( const QString& s, const QString& c )
{
...
void MessagesStatusWidget::appendMessagesText ( const QString& s )
{
	appendMessagesLine(s);
	appendMessagesLog(s);
}

void MessagesStatusWidget::resetXrunStats ()
{
	MainWidget *pMainForm = MainWidget::getInstance();
	if (pMainForm)
...
void MessagesStatusWidget::refreshXrunStats ()
{
	MainWidget *pMainForm = MainWidget::getInstance();
	if (pMainForm)
...
void MessagesStatusWidget::updateStatusItem ( int iStatusItem,
	const QString& sText )
{
	m_apStatus[iStatusItem]->setText(1, sText);
}

void MessagesStatusWidget::keyPressEvent ( QKeyEvent *pKeyEvent )
{
