...
//	connect(m_ui.PresetComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(changeCurrentPreset(const QString&)));
//	connect(m_ui.PresetSavePushButton,
//		SIGNAL(clicked()),
//		SLOT(saveCurrentPreset()));
//	connect(m_ui.PresetDeletePushButton,
//		SIGNAL(clicked()),
//		SLOT(deleteCurrentPreset()));

//	connect(m_ui.DriverComboBox,
//		SIGNAL(highlighted(const QString&)),
//		SLOT(changeDriver(const QString&)));
//	connect(m_ui.AudioComboBox,
//		SIGNAL(highlighted(int)),
//		SLOT(changeAudio(int)));
//	connect(m_ui.ServerPrefixComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.ServerNameComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.DriverComboBox,
//		SIGNAL(activated(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.RealtimeCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.NoMemLockCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.SoftModeCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.MonitorCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.ShortsCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.HWMonCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.HWMeterCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.IgnoreHWCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.UnlockMemCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.VerboseCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.PrioritySpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.FramesComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.SampleRateComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.PeriodsSpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.WordLengthComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.WaitComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.ChanSpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//    connect(m_ui.interfaceComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.AudioComboBox,
//		SIGNAL(activated(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.DitherComboBox,
//		SIGNAL(activated(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.TimeoutComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.InDeviceComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.OutDeviceComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.InChannelsSpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.OutChannelsSpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.InLatencySpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.OutLatencySpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.MidiDriverComboBox,
//		SIGNAL(activated(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.StartDelaySpinBox,
//		SIGNAL(valueChanged(int)),
//		SLOT(settingsChanged()));
//	connect(m_ui.PortMaxComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));
//	connect(m_ui.ServerSuffixComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(settingsChanged()));

//	connect(m_ui.StartupScriptCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.StartupScriptShellComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.PostStartupScriptCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.PostStartupScriptShellComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ShutdownScriptCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ShutdownScriptShellComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.PostShutdownScriptCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.PostShutdownScriptShellComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.StartupScriptBrowseToolButton,
//		SIGNAL(clicked()),
//		SLOT(browseStartupScript()));
//	connect(m_ui.PostStartupScriptBrowseToolButton,
//		SIGNAL(clicked()),
//		SLOT(browsePostStartupScript()));
//	connect(m_ui.ShutdownScriptBrowseToolButton,
//		SIGNAL(clicked()),
//		SLOT(browseShutdownScript()));
//	connect(m_ui.PostShutdownScriptBrowseToolButton,
//		SIGNAL(clicked()),
//		SLOT(browsePostShutdownScript()));
//	connect(m_ui.StartupScriptSymbolToolButton,
//		SIGNAL(clicked()),
//		SLOT(symbolStartupScript()));
//	connect(m_ui.PostStartupScriptSymbolToolButton,
//		SIGNAL(clicked()),
//		SLOT(symbolPostStartupScript()));
//	connect(m_ui.ShutdownScriptSymbolToolButton,
//		SIGNAL(clicked()),
//		SLOT(symbolShutdownScript()));
//	connect(m_ui.PostShutdownScriptSymbolToolButton,
//		SIGNAL(clicked()),
//		SLOT(symbolPostShutdownScript()));

//	connect(m_ui.StdoutCaptureCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.XrunRegexComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ActivePatchbayCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ActivePatchbayPathComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ActivePatchbayPathToolButton,
//		SIGNAL(clicked()),
//		SLOT(browseActivePatchbayPath()));
//#ifdef CONFIG_AUTO_REFRESH
//	connect(m_ui.AutoRefreshCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.TimeRefreshComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//#endif
//	connect(m_ui.MessagesLogCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.MessagesLogPathComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.MessagesLogPathToolButton,
//		SIGNAL(clicked()),
//		SLOT(browseMessagesLogPath()));
//	connect(m_ui.TransportTimeRadioButton,
//		SIGNAL(toggled(bool)),
//		SLOT(optionsChanged()));
//	connect(m_ui.TransportBBTRadioButton,
//		SIGNAL(toggled(bool)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ElapsedResetRadioButton,
//		SIGNAL(toggled(bool)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ElapsedXrunRadioButton,
//		SIGNAL(toggled(bool)),
//		SLOT(optionsChanged()));
//	connect(m_ui.TimeFormatComboBox,
//		SIGNAL(activated(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.DisplayEffectCheckBox,
//		SIGNAL(toggled(bool)),
//		SLOT(toggleDisplayEffect(bool)));
//	connect(m_ui.DisplayBlinkCheckBox,
//		SIGNAL(toggled(bool)),
//		SLOT(optionsChanged()));
//	connect(m_ui.DisplayFont1PushButton,
//		SIGNAL(clicked()),
//		SLOT(chooseDisplayFont1()));
//	connect(m_ui.DisplayFont2PushButton,
//		SIGNAL(clicked()),
//		SLOT(chooseDisplayFont2()));
//	connect(m_ui.MessagesFontPushButton,
//		SIGNAL(clicked()),
//		SLOT(chooseMessagesFont()));
//	connect(m_ui.ConnectionsFontPushButton,
//		SIGNAL(clicked()),
//		SLOT(chooseConnectionsFont()));
//	connect(m_ui.MessagesLimitCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.MessagesLimitLinesComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ConnectionsIconSizeComboBox,
//		SIGNAL(activated(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.BezierLinesCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.AliasesEnabledCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.AliasesEditingCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.JackClientPortAliasComboBox,
//		SIGNAL(activated(int)),
//		SLOT(optionsChanged()));

//	connect(m_ui.StartJackCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.StopJackCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.QueryCloseCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.KeepOnTopCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.SystemTrayCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.StartMinimizedCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.DelayedSetupCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.SingletonCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.SingletonCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ServerConfigNameComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
//	connect(m_ui.ServerConfigTempCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.QueryShutdownCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.AlsaSeqEnabledCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.DBusEnabledCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.LeftButtonsCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.RightButtonsCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.TransportButtonsCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.TextLabelsCheckBox,
//		SIGNAL(stateChanged(int)),
//		SLOT(optionsChanged()));
//	connect(m_ui.BaseFontSizeComboBox,
//		SIGNAL(editTextChanged(const QString&)),
//		SLOT(optionsChanged()));
...
//void SetupDialog::setComboBoxCurrentText (
...
//void SetupDialog::setup ( Setup *pSetup )
//{
...
//void SetupDialog::changePreset ( const QString& sPreset )
//{
//	if (sPreset.isEmpty())
//		return;
...
//bool SetupDialog::savePreset ( const QString& sPreset )
//{
//	if (sPreset.isEmpty())
//		return false;
...
//bool SetupDialog::deletePreset ( const QString& sPreset )
//{
//	if (sPreset.isEmpty())
//		return false;
...
//void SetupDialog::changeCurrentPreset ( const QString& sPreset )
//{
//	if (m_iDirtySetup > 0)
//		return;
...
//void SetupDialog::saveCurrentPreset ()
//{
...
//void SetupDialog::deleteCurrentPreset ()
//{
//	const QString sPreset = m_ui.PresetComboBox->currentText();
...
//void SetupDialog::computeLatency ()
//{
//	float lat = 0.0;
...
//void SetupDialog::changeDriverAudio ( const QString& sDriver, int iAudio )
//{
...
//void SetupDialog::changeAudio ( int iAudio )
//{
//	changeDriverAudio(m_ui.DriverComboBox->currentText(), iAudio);
//}


//void SetupDialog::changeDriver ( const QString& sDriver )
//{
//	changeDriverUpdate(sDriver, true);
//}


//void SetupDialog::changeDriverUpdate ( const QString& sDriver, bool bUpdate )
//{
...
//void SetupDialog::stabilizeForm ()
//{
...
//void SetupDialog::symbolMenu( QLineEdit *pLineEdit,
...
//void SetupDialog::symbolStartupScript ()
//{
...
//void SetupDialog::symbolPostStartupScript ()
//{
...
//void SetupDialog::symbolShutdownScript ()
//{
...
//void SetupDialog::symbolPostShutdownScript ()
//{
...
//void SetupDialog::browseStartupScript()
//{
...
//void SetupDialog::browsePostStartupScript()
//{
//	QString sFileName = QFileDialog::getOpenFileName(
//		this,												// Parent.
...
//void SetupDialog::browseShutdownScript()
//{
//	QString sFileName = QFileDialog::getOpenFileName(
//		this,												// Parent.
...
//void SetupDialog::browsePostShutdownScript()
//{
//	QString sFileName = QFileDialog::getOpenFileName(
//		this,												// Parent.
...
//void SetupDialog::browseActivePatchbayPath()
//{
//	QString sFileName = QFileDialog::getOpenFileName(
//		this,											// Parent.
...
//void SetupDialog::browseMessagesLogPath()
//{
...
//void SetupDialog::chooseDisplayFont1()
//{
//	bool  bOk  = false;
...
//void SetupDialog::chooseDisplayFont2()
//{
//	bool  bOk  = false;
//	QFont font = QFontDialog::getFont(&bOk,
...
//void SetupDialog::toggleDisplayEffect ( bool bOn )
//{
//	QPalette pal;
...
//void SetupDialog::chooseMessagesFont ()
//{
//	bool  bOk  = false;
//	QFont font = QFontDialog::getFont(&bOk,
...
//void SetupDialog::chooseConnectionsFont ()
//{
//	bool  bOk  = false;
//	QFont font = QFontDialog::getFont(&bOk,
...
//void SetupDialog::settingsChanged ()
//{
//	if (m_iDirtySetup > 0)
//		return;
...
//void SetupDialog::optionsChanged ()
//{
//	if (m_iDirtySetup > 0)
//		return;
